...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2026-02-01T08:53:11.897Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2026-02-01T08:53:11.897Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "8cffabc1-3e23-4d53-a309-b0d50c2b6064",
...
const _h0qkaXMqKGpa9MkGM6yCSKdKzkKsu9AeTXHWQg81M8Q = defineNitroPlugin(async (nitroApp) => {
...
const _2IrrIOsHcYKMmS1OstK3OP9u2oGyCP3HG5qNtw4UoRk = defineNitroPlugin(async (nitroApp) => {
...
const theme = {"colors":{"primary":"rgb(var(--gold) / <alpha-value>)","gold":"rgb(var(--gold) / <alpha-value>)","ink":"rgb(var(--ink) / <alpha-value>)","midnight":"rgb(var(--midnight) / <alpha-value>)","royal":"rgb(var(--royal) / <alpha-value>)","ivory":"rgb(var(--ivory) / <alpha-value>)","pearl":"rgb(var(--pearl) / <alpha-value>)","champagne":"rgb(var(--champagne) / <alpha-value>)","soft":"rgb(var(--ivory) / <alpha-value>)"},"fontFamily":{"sans":["\"Noto Sans JP\"","system-ui","Arial","sans-serif"],"display":["\"Playfair Display\"","\"Cormorant Garamond\"","\"Noto Serif JP\"","serif"],"serif":["\"Noto Serif JP\"","serif"]},"boxShadow":{"card":"0 20px 45px -25px rgba(17, 24, 39, 0.35)","glow":"0 10px 25px -10px rgba(189, 160, 106, 0.45)"},"transitionTimingFunction":{"soft":"cubic-bezier(0.4, 0, 0.2, 1)"},"backgroundImage":{"hero-overlay":"linear-gradient(180deg, rgba(0,0,0,.4) 0%, rgba(0,0,0,.6) 100%)"}};
...
const _kGCIjwHWR1cA2qfzdisY55sq1BO3bNmcbvSXxXEVUIs = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _h0qkaXMqKGpa9MkGM6yCSKdKzkKsu9AeTXHWQg81M8Q,
_2IrrIOsHcYKMmS1OstK3OP9u2oGyCP3HG5qNtw4UoRk,
_kGCIjwHWR1cA2qfzdisY55sq1BO3bNmcbvSXxXEVUIs
];

const _ZKGQ4Q = eventHandler(async (e) => {
...
const _K2i6fd = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _nlPJ6r = defineEventHandler(async (e) => {
...
const _NqakO8 = defineEventHandler(async (e) => {
...
const _LeKV37 = defineEventHandler(async (e) => {
...
const appHead = {"link":[{"rel":"icon","type":"image/png","href":"/shared/favicon.png"},{"rel":"icon","type":"image/x-icon","href":"/shared/favicon.ico"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"preload","as":"style","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Cormorant+Garamond:wght@400;600;700&family=Noto+Serif+JP:wght@400;600;700&display=swap","onload":"this.onload=null;this.rel='stylesheet'"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Cormorant+Garamond:wght@400;600;700&family=Noto+Serif+JP:wght@400;600;700&display=swap"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"description","content":"Wedding day guide and seating chart for {{COUPLE}}."},{"property":"og:title","content":"Wedding Day Seating for {{COUPLE}}"},{"property":"og:description","content":"Seating chart and timeline for {{COUPLE}} at {{VENUE_NAME}} on {{DATE_ISO}}."},{"property":"og:type","content":"website"},{"property":"og:image","content":"/og.png"},{"property":"og:image:width","content":"1200"},{"property":"og:image:height","content":"630"},{"name":"twitter:card","content":"summary_large_image"},{"name":"theme-color","content":"#BDA06A"}],"style":[],"script":[],"noscript":[],"title":"Wedding Day Seating","htmlAttrs":{}};
...
const _lazy_zpUh1H = () => import('../routes/api/event.get.mjs');
const _lazy_WSiVXQ = () => import('../routes/api/leaderboard.get.mjs');
const _lazy_3m32pI = () => import('../routes/api/leaderboard.post.mjs');
const _lazy_f3qJ_d = () => import('../routes/api/leaderboard/stream.get.mjs');
const _lazy_UPLaGM = () => import('../routes/api/photos.get.mjs');
const _lazy_ap8QPc = () => import('../routes/api/photos.post.mjs');
const _lazy_uhFw0Y = () => import('../routes/renderer.mjs');
const _lazy_tH6ZJW = () => import('../routes/__og-image__/font/font.mjs');
const _lazy__V4jZt = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/event', handler: _lazy_zpUh1H, lazy: true, middleware: false, method: "get" },
  { route: '/api/leaderboard', handler: _lazy_WSiVXQ, lazy: true, middleware: false, method: "get" },
  { route: '/api/leaderboard', handler: _lazy_3m32pI, lazy: true, middleware: false, method: "post" },
  { route: '/api/leaderboard/stream', handler: _lazy_f3qJ_d, lazy: true, middleware: false, method: "get" },
  { route: '/api/photos', handler: _lazy_UPLaGM, lazy: true, middleware: false, method: "get" },
  { route: '/api/photos', handler: _lazy_ap8QPc, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _ZKGQ4Q, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _K2i6fd, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _nlPJ6r, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _NqakO8, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _LeKV37, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_tH6ZJW, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy__V4jZt, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy__V4jZt, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/photos/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/api/leaderboard/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/meta/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uhFw0Y, lazy: true, middleware: false, method: undefined }
];
...
export { useHead as $, joinURL as A, replaceIslandTeleports as B, useNitroApp as C, getNitroOrigin as D, prefixStorage as E, useStorage as F, emojiCache as G, useOgImageRuntimeConfig as H, fetchIsland as I, createHeadCore as J, normaliseFontInput as K, theme as L, withTrailingSlash as M, handleCacheHeaders as N, setHeaders as O, hash$1 as P, parseURL as Q, setResponseHeader as R, proxyRequest as S, sendRedirect as T, resolveContext as U, H3Error as V, parseQuery as W, klona as X, getRequestHeaders as Y, defu as Z, headSymbol as _, getHeader as a, parse as a0, getRequestHeader as a1, isEqual as a2, withQuery as a3, withoutTrailingSlash as a4, isScriptProtocol as a5, setCookie as a6, deleteCookie as a7, getContext as a8, sanitizeStatusCode as a9, $fetch$1 as aa, baseURL as ab, createHooks as ac, executeAsync as ad, titleCase as ae, defuFn as af, toRouteMatcher as ag, createRouter$1 as ah, camelCase as ai, withoutBase as aj, useSeoMeta as ak, stringifyQuery as al, withLeadingSlash as am, withBase as an, resolveUnrefHeadInput as ao, decodeHtml as ap, logger$1 as aq, toBase64Image as ar, htmlDecodeQuotes as as, sendError as at, fontCache as au, handler as av, getQuery as b, createError$1 as c, defineEventHandler as d, readMultipartFormData as e, getResponseStatusText as f, getCookie as g, getResponseStatus as h, appId as i, defineRenderHandler as j, buildAssetsURL as k, appTeleportTag as l, appTeleportAttrs as m, createSSRContext as n, appHead as o, publicAssetsURL as p, destr as q, readBody as r, setHeader as s, setSSRError as t, useRuntimeConfig as u, getRouteRules as v, getRenderer as w, getEntryIds as x, renderInlineStyles as y, hasProtocol as z };
