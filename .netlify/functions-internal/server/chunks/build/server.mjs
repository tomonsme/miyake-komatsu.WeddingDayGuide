import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, hasInjectionContext, inject, ref, computed, getCurrentInstance, createElementBlock, provide, cloneVNode, useSlots, Fragment, Suspense, useSSRContext, unref, shallowReactive, createApp, reactive, toRaw, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, defineAsyncComponent, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, isReadonly, isRef, isShallow, isReactive, toValue as toValue$1, watch, nextTick, getCurrentScope, onUnmounted, onScopeDispose, onMounted } from 'vue';
import { W as parseQuery, q as destr, X as klona, c as createError$1, Y as getRequestHeaders, Z as defu, _ as headSymbol, $ as useHead$1, z as hasProtocol, A as joinURL, a0 as parse, a1 as getRequestHeader, a2 as isEqual, a3 as withQuery, M as withTrailingSlash, a4 as withoutTrailingSlash, a5 as isScriptProtocol, a6 as setCookie, g as getCookie, a7 as deleteCookie, a8 as getContext, a9 as sanitizeStatusCode, aa as $fetch, ab as baseURL, p as publicAssetsURL, ac as createHooks, ad as executeAsync, ae as titleCase, af as defuFn, ag as toRouteMatcher, ah as createRouter$1, ai as camelCase, Q as parseURL, aj as withoutBase, ak as useSeoMeta$1, al as stringifyQuery, am as withLeadingSlash, an as withBase, ao as resolveUnrefHeadInput } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "guide",
    path: "/guide",
    component: () => import('./guide-U871ITZA.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BDqXkT85.mjs')
  },
  {
    name: "notes",
    path: "/notes",
    component: () => import('./notes-D3aP8v26.mjs')
  },
  {
    name: "access",
    path: "/access",
    component: () => import('./access-Bg3CS9PT.mjs')
  },
  {
    name: "photos",
    path: "/photos",
    component: () => import('./photos-D9scwLEK.mjs')
  },
  {
    name: "message",
    path: "/message",
    component: () => import('./message-CpPtdmOY.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-CcClBf6s.mjs')
  },
  {
    name: "seating",
    path: "/seating",
    component: () => import('./seating-Dir6v7mP.mjs')
  },
  {
    name: "favorites-1",
    path: "/favorites-1",
    component: () => import('./favorites-1-RQ243zg3.mjs')
  },
  {
    name: "favorites-2",
    path: "/favorites-2",
    component: () => import('./favorites-2-BwewtwCT.mjs')
  }
];
...
const componentNames = [{ "hash": "TSsLEaYSNHiOdoSDkuHyg0tffqUe7fxSs-0dEDiwBuw", "pascalName": "BrandedLogoDVue", "kebabName": "branded-logo-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM", "pascalName": "BrandedLogo", "kebabName": "branded-logo", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue", "category": "community" }, { "hash": "uLI51ek65D2H9ANn1bo-U4Sz9agbfBAuaVWpejfq2cI", "pascalName": "FrameDVue", "kebabName": "frame-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.d.vue.ts", "category": "community", "credits": "@arashsheyda <https://github.com/arashsheyda>" }, { "hash": "tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY", "pascalName": "Frame", "kebabName": "frame", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue", "category": "community" }, { "hash": "KY4HdN0ICr8Fetf79gWEytJ3i4uNQDJJUcnlxKtKDr4", "pascalName": "NuxtDVue", "kebabName": "nuxt-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.d.vue.ts", "category": "community" }, { "hash": "NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM", "pascalName": "Nuxt", "kebabName": "nuxt", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue", "category": "community" }, { "hash": "P-MXBD4anUhDUGpeI7NDfl81Z2uyyiGPidJS2NHymPA", "pascalName": "NuxtSeoDVue", "kebabName": "nuxt-seo-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.d.vue.ts", "category": "community" }, { "hash": "VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4", "pascalName": "NuxtSeo", "kebabName": "nuxt-seo", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue", "category": "community" }, { "hash": "KY4HdN0ICr8Fetf79gWEytJ3i4uNQDJJUcnlxKtKDr4", "pascalName": "PergelDVue", "kebabName": "pergel-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.d.vue.ts", "category": "community" }, { "hash": "8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM", "pascalName": "Pergel", "kebabName": "pergel", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue", "category": "community" }, { "hash": "iV-6cePv5ka0uLfeLNbb5ZtIIggID-5d4v-asMzXuSc", "pascalName": "SimpleBlogDVue", "kebabName": "simple-blog-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.d.vue.ts", "category": "community" }, { "hash": "b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s", "pascalName": "SimpleBlog", "kebabName": "simple-blog", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue", "category": "community" }, { "hash": "DyqwkTE9c6-GRC7AJjw7vd99zMPNwt5L6VzDDLBZ5S0", "pascalName": "UnJsDVue", "kebabName": "un-js-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.d.vue.ts", "category": "community", "credits": "UnJS <https://unjs.io/>" }, { "hash": "vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI", "pascalName": "UnJs", "kebabName": "un-js", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue", "category": "community" }, { "hash": "wV8blmc9tIdHoj1aylO8PlSvEGKMji3BRzVS68KDVA0", "pascalName": "WaveDVue", "kebabName": "wave-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw", "pascalName": "Wave", "kebabName": "wave", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue", "category": "community" }, { "hash": "sA3J89dfCZp-NHqCifUrYcOAHzCk9yi5v2VXIYwz2Hs", "pascalName": "WithEmojiDVue", "kebabName": "with-emoji-d-vue", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.d.vue.ts", "category": "community", "credits": "Full Stack Heroes <https://fullstackheroes.com/>" }, { "hash": "zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws", "pascalName": "WithEmoji", "kebabName": "with-emoji", "path": "/Users/tomoyamiyake/Desktop/wedding-invite2/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue", "category": "community" }];
...
const _imports_0 = publicAssetsURL("/shared/favicon.png");
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const items = [
      ...
      { id: "guide", label: "Extras", to: "/guide" },
      { id: "seating", label: "Seating", to: "/seating" },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({
        class: ["sticky top-0 z-40 w-full border-b border-champagne/40 bg-royal/85 backdrop-blur transition-colors duration-300", { "bg-royal/95 border-champagne/60": unref(scrolled) }]
      }, _attrs))}><div class="relative mx-auto flex max-w-screen-lg items-center justify-end px-4 py-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "absolute left-1/2 flex -translate-x-1/2 items-center gap-2"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="logo" class="h-6 w-6"${_scopeId}><span class="font-display text-base sm:text-lg tracking-wide text-white text-shadow-soft uppercase whitespace-nowrap"${_scopeId}>Wedding Day</span>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
              ...
              createVNode("span", { class: "font-display text-base sm:text-lg tracking-wide text-white text-shadow-soft uppercase whitespace-nowrap" }, "Wedding Day")
            ];
          }
        }),
        _: 1
      ...
      ssrRenderList(items, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          class: ["relative rounded-md px-2 py-1 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/60 uppercase tracking-wide", {
            "text-white after:absolute after:left-1/2 after:-bottom-0.5 after:h-[2px] after:w-6 after:-translate-x-1/2 after:rounded-full after:bg-gold after:transition-all after:duration-300": unref(route).path === item.to
          }],
          "aria-current": unref(route).path === item.to ? "page" : void 0
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "mt-16 border-t border-[#DCC08E]/30 bg-gradient-to-b from-[#0E1828] to-[#111E33]" }, _attrs))}><div class="mx-auto max-w-screen-lg px-6 py-10"><div class="mb-6 flex flex-col items-center">`);
      if (unref(monogramUrl)) {
        _push(`<img${ssrRenderAttr("src", unref(monogramUrl))} alt="monogram" class="h-8 w-auto opacity-90" loading="lazy">`);
      } else {
        _push(`<!---->`);
      }
      _push(`<span class="mt-3 block h-px w-16 bg-[#DCC08E]/50"></span></div><div class="grid gap-8 md:grid-cols-2 text-center md:text-left"><div class="max-w-prose mx-auto md:mx-0"><h3 class="font-display text-lg tracking-wide text-white">Wedding Day</h3>`);
      _push(ssrRenderComponent(_sfc_main$7, null, null, _parent));
      _push(`<p class="mt-2 text-sm leading-relaxed text-white/80">本日はご来場ありがとうございます 席次表をご確認ください</p></div><div class="max-w-prose mx-auto md:mx-0"><h4 class="text-[11px] font-semibold uppercase tracking-[0.3em] text-white/85">Contact</h4><p class="mt-2 text-sm leading-relaxed text-white/80">ご不明点は受付スタッフまでお声がけください</p></div></div><div class="mt-8 text-center text-xs text-white/40 tracking-wide"><p>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Wedding Day</p></div></div></footer>`);
    };
  }
});
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/GoldParticles.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const GoldParticles = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e9213f5c"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const show = ref(true);
    const styleA = {
      background: "radial-gradient(60% 40% at 50% 20%, rgba(255,255,255,.12), rgba(255,255,255,0) 70%)"
    };
    const styleB = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(show)) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          ...
          "aria-hidden": "true"
        }, _attrs))} data-v-a7503ec9><div class="absolute inset-0" style="${ssrRenderStyle(styleA)}" data-v-a7503ec9></div><div class="absolute inset-0" style="${ssrRenderStyle(styleB)}" data-v-a7503ec9></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/LightReveal.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const LightReveal = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a7503ec9"]]);
const _sfc_main$3 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: "sparkles",
    "aria-hidden": "true"
  }, _attrs))}><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "6%", "top": "6%", "width": "4px", "height": "4px", "animation-delay": ".2s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "14%", "top": "4%", "width": "3px", "height": "3px", "animation-delay": "1.1s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "24%", "top": "8%", "width": "5px", "height": "5px", "animation-delay": ".5s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "38%", "top": "5%", "width": "3px", "height": "3px", "animation-delay": "1.4s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "52%", "top": "7%", "width": "4px", "height": "4px", "animation-delay": ".7s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "66%", "top": "4%", "width": "3px", "height": "3px", "animation-delay": "1.2s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "78%", "top": "6%", "width": "4px", "height": "4px", "animation-delay": ".3s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "90%", "top": "9%", "width": "3px", "height": "3px", "animation-delay": ".9s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "8%", "top": "10%", "width": "5px", "height": "5px", "animation-delay": "0s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "18%", "top": "22%", "width": "4px", "height": "4px", "animation-delay": ".6s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "32%", "top": "14%", "width": "6px", "height": "6px", "animation-delay": ".3s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "46%", "top": "8%", "width": "4px", "height": "4px", "animation-delay": "1.1s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "58%", "top": "18%", "width": "5px", "height": "5px", "animation-delay": ".2s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "72%", "top": "12%", "width": "4px", "height": "4px", "animation-delay": ".9s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "84%", "top": "20%", "width": "6px", "height": "6px", "animation-delay": ".5s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "12%", "top": "34%", "width": "4px", "height": "4px", "animation-delay": ".8s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "40%", "top": "32%", "width": "5px", "height": "5px", "animation-delay": ".1s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "64%", "top": "30%", "width": "4px", "height": "4px", "animation-delay": "1.3s" })}"></span><span class="sparkle sparkle--gold" style="${ssrRenderStyle({ "left": "90%", "top": "36%", "width": "5px", "height": "5px", "animation-delay": ".4s" })}"></span><span class="sparkle sparkle--amber" style="${ssrRenderStyle({ "left": "28%", "top": "44%", "width": "4px", "height": "4px", "animation-delay": "1.5s" })}"></span></div>`);
}
const _sfc_setup$3 = _sfc_main$3.setup;
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/Sparkles.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const Sparkles = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["min-h-screen relative overflow-x-hidden", {
          "is-game-arcade": unref(route).path === "/guide",
          "font-serif bg-gradient-to-b from-ink to-midnight": unref(route).path !== "/guide"
        }]
      }, _attrs))}>`);
      if (unref(route).path !== "/guide") {
        _push(ssrRenderComponent(GoldParticles, { class: "pointer-events-none absolute inset-0 z-0" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (unref(route).path !== "/guide") {
        _push(ssrRenderComponent(Sparkles, { class: "pointer-events-none absolute inset-0 z-[1]" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      ...
      if (unref(route).path !== "/guide") {
        _push(ssrRenderComponent(LightReveal, null, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-XmKIRgA2.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { __nuxt_component_0$2 as _, useRoute as a, useCookie as b, createError as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, useRequestHeaders as f, useOgImageRuntimeConfig as g, useSiteConfig as h, injectHead as i, useHead as u };
