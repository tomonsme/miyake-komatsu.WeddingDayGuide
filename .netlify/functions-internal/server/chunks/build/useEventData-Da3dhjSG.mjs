...
import { f as useRequestHeaders, d as useNuxtApp, e as asyncDataDefaults, c as createError } from './server.mjs';
...
function useEventData() {
  ...
  const { data: eventData } = useAsyncData("event-config", async () => {
    try {
      return await $fetch("/api/event", { headers });
    } catch (err) {
      return null;
    }
  });
...
export { useEventData as u };
//# sourceMappingURL=useEventData-Da3dhjSG.mjs.map
